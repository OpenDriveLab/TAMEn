...
#        GroupAction([right_fixed_camera]),
        TimerAction(period=3.0, actions=[GroupAction([head_camera])]), # The primary camera should be launched at last
